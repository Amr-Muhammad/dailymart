    ...
    <div class="relative ">
        <section class="hero-sec mb-16 bg-cover h-screen">
            <div class=" text-white bg-[#00000080] w-full h-full  p-8 flex flex-col justify-center items-center">
                ...
                <p class="w-full lg:w-6/12 text-xs md:text-lg text-center">We're here to help you easily find unboycotted products.
                    Make it simple and convenient to support the brands you believe in.</p>
                <button class="hero-btn btn w-fit bg-[#DB4444] border-[#DB4444] px-16 mt-10 transition-all font-bold md:text-xl text-white hover:bg-[#0A1E1E] hover:border-[#0A1E1E]">Discover</button>
            </div>
        </section>
        <section class="sale-sec bg-white p-5 mb-16 text-center">
            <div class="head">
                <h2>Exclusive Deals Await You</h2>
                <p>Explore our range of exclusive deals on unboycotted products that are chosen to give you the best value and experience.</p>
            </div>
            <div class="cards grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3 mb-8">
                <div v-for="prd in salePrds" :key="prd" class="card bg-base-100 transition-all shadow-md hover:shadow-2xl">
                    <figure class="p-0">
                    ...
                    <div class="card-body items-center text-center py-3">
                        ...
                        <div class="rating rating-md">
                            ...
                            <input type="radio" name="rating-7" class="mask mask-star-2 bg-amber-400 me-1" />
                            <input type="radio" name="rating-7" class="mask mask-star-2 bg-amber-400 me-1" checked="checked" />
                            <input type="radio" name="rating-7" class="mask mask-star-2 bg-amber-400 me-1" />
                        ...
                        <div class="price relative mb-3">
                            ...
                            <div class="before text-md absolute top-2 -left-10 before:content-[''] before:absolute before:bg-[#DB4444] before:block before:w-0.5 before:h-7 before:rotate-90 before:left-4 before:top-0">
            ...
            <button @click="gotoOffers()" class="btn px-10 transition-all font-bold text-white border-0 bg-[#DB4444] hover:bg-[#0A1E1E] hover:border-[#0A1E1E]">Find more</button>
        </section>
        <section class="featured bg-slate-50 px-5 py-16 text-center">
            ...
            :pause-autoplay-on-hover="true" :breakpoints="prdsBreakpoints" class="prds">
                    <Slide v-for="prd in prds" :key="prd" class="flex flex-col sm:mx-auto md:mx-0 sm:mb-3 lg:mb-0">
                        <div class="face image absolute flex justify-center items-center rounded-lg shadow-md  overflow-hidden w-full h-full text-center">
                            <img :src="prd.src" class="max-w-[150px]">
                            <span class="prd-action absolute bg-[#0a1e1e] bottom-0 left-0 p-1 text-lg w-full shadow-md text-white font-semibold">Click</span>
                        </div>
                        <div class="face info bg-[#DAFFDA] rounded-lg shadow-md w-full h-full text-center">
                                <div class="card-body items-center text-center py-3 px-2 bg-white m-3 rounded-lg shadow-sm">
                                    ...
                                    <div class="rating rating-sm">
                                        ...
                                        <input type="radio" name="rating-6" class="mask mask-star-2 bg-amber-400 me-1" />
                                        <input type="radio" name="rating-6" class="mask mask-star-2 bg-amber-400 me-1" checked="checked" />
                                        <input type="radio" name="rating-6" class="mask mask-star-2 bg-amber-400 me-1" />
                                    ...
                                    <div class="card-actions justify-end">
                                        <button class="btn border-0 text-white transition-all bg-[#DB4444] hover:bg-[#0A1E1E] hover:border-[#0A1E1E]">See more</button>
                                    </div>
                            </div>
                        </div>
                    </Slide>
                ...
                <div class="hero-content text-neutral-content text-center">
                    <div class="max-w-lg">
                        <p class="mb-5 text-white md:text-lg">
                            Help in the fight for Palestinian freedom and dignity by making conscious choices that support justice and equality.
                        </p>
                        <button class="btn bg-[#DAFFDA] hover:bg-[#DB4444] hover:text-white btn-primary px-20 border-0 transition-all md:text-lg font-semibold">See Your Impact</button>
                    </div>
                </div>
            </div>
        </section>
        <section class="boycotted bg-slate-50 px-5 py-16 mb-16 text-center">
            <div class="head">
                ...
                <p>Products we don't sell due to their boycott status. We prioritize offering alternatives that align with our values and commitment.</p>
            </div>
            <Carousel :itemsToShow="3.95" :wrapAround="true" :transition="1500" :autoplay="true" :snap-align="'center'"
            :pause-autoplay-on-hover="true" :breakpoints="breakpoints" class="boycotted-prds  gap-5">
                <Slide v-for="item in items" :key="item" class="img  relative">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-55 absolute z-10 stroke-red-600">
            ...
            <button class="btn px-10 mt-10 transition-all font-bold text-white border-0 bg-[#DB4444] hover:bg-[#0A1E1E] hover:border-[#0A1E1E]">See more</button>
        </section>
        <section class="top-rated bg-white p-5 mb-16">
            ...
            <div class="rated-cards grid sm:grid-cols-1 lg:grid-cols-3 gap-5">
                <div v-for="prd in ratedPrds" :key="prd" class="card card-side bg-base-100 transition-all shadow-md hover:shadow-2xl">
                    <figure class="w-1/2">
                    ...
                    <div class="card-body bg-[#daffda47] w-1/2 p-3 justify-center">
                        ...
                        <div class="card-actions justify-end mx-auto">
                            <button class="btn bg-[#DB4444] hover:bg-[#0A1E1E] border-0 text-white duration-[500]">BUY NOW</button>
                        </div>
                    </div>
                </div>
            </div>
