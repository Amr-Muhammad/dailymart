            ...
            <div v-for="(product, index) in products" :key="index"
                ...
                <div class="border rounded-md">
                    <figure class="bg-stone-50 p-5 relative">
                        <img :src="product[1].image_url" alt="" class="w-1/2 bg-red-600" />
...
export default {
    ...
    methods: {
        async getAllProducts() {
            this.products = await service.methods.getAllProducts(this.searchQuery, this.categoryId)
        },
