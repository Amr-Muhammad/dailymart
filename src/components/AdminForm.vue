<template>
  <form @submit.prevent="addAdmin"
    class="flex flex-col grow items-center px-20 pt-16 pb-40 w-full text-sm bg-white rounded-xl border-zinc-100  text-zinc-500 max-md:px-5 max-md:pb-24 max-md:mt-10 max-md:max-w-full">
