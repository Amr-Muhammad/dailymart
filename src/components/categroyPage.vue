            ...
            <section class="flex flex-wrap">
                <div v-for="(product, index) in products" :key="index"
                    ...
                    <div class="border rounded-md hover:scale-[1.01] transition-all hover:shadow-lg duration-300">
                        <figure class="bg-stone-50 p-5 relative ">
                            ...
                            <div class="badges absolute top-3 px-3 w-full flex justify-between">
                                ...
                                <svg @click="addToWishlist(product[0], product[1])" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    class="size-5 cursor-pointer hover:fill-[#DB4444] transition-all duration-1000 ms-auto text-[#DB4444]">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div
                            class="cart-btn  hover:bg-slate-800 hover:text-white border w-full p-2 font-bold text-center flex gap-3 justify-center">
                            <button @click="addToCart(product[0], product[1])" class="">
                                Add To Cart</button>
                            <svg class="stroke-white text-white" width="30px" height="30px" viewBox="0 0 24.00 24.00"
                                fill="none" xmlns="http://www.w3.org/2000/svg" transform="matrix(-1, 0, 0, 1, 0, 0)">
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    <path
                                        ...
                                        stroke="#1C274C" stroke-width="0.8399999999999999"></path>
                                    <path
                                        d="M16.5 18.0001C17.3284 18.0001 18 18.6716 18 19.5001C18 20.3285 17.3284 21.0001 16.5 21.0001C15.6716 21.0001 15 20.3285 15 19.5001C15 18.6716 15.6716 18.0001 16.5 18.0001Z"
                                        stroke="#1C274C" stroke-width="0.8399999999999999"></path>
                                    <path
                                        d="M2 3L2.26121 3.09184C3.5628 3.54945 4.2136 3.77826 4.58584 4.32298C4.95808 4.86771 4.95808 5.59126 4.95808 7.03836V9.76C4.95808 12.7016 5.02132 13.6723 5.88772 14.5862C6.75412 15.5 8.14857 15.5 10.9375 15.5H12M16.2404 15.5C17.8014 15.5 18.5819 15.5 19.1336 15.0504C19.6853 14.6008 19.8429 13.8364 20.158 12.3075L20.6578 9.88275C21.0049 8.14369 21.1784 7.27417 20.7345 6.69708C20.2906 6.12 18.7738 6.12 17.0888 6.12H11.0235M4.95808 6.12H7"
                                        stroke="#1C274C" stroke-width="0.8399999999999999" stroke-linecap="round">
                                    </path>
                                </g>
                            </svg>
    ...
    methods: {
        ...
        async addToCart(productId, product) {
            ...
            try {
                ...
                if (flag) {
                    try {
                        await service.methods.patchCartQuantity(this.userId, productId, 'cart')
                    }
                    catch (err) {
                        console.log(err);
                    }
                    ...
                    try {
                        await service.methods.addTo_cart_wishlist(this.userId, productId, {
                            ...product,
                            quantity: 1
                        }, 'cart')
                    }
