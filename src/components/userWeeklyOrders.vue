<template>
    ...
    <div>
        <h2 class="ms-20 text-2xl font-semibold">Weekly Orders</h2>
    </div>

    <div class="items-wrapper w-full px-4 mt-10">

        <div class="flex flex-wrap items-center justify-between my-7 mx-16 p-3 rounded-lg shadow-md bg-white">
            ...
            <div class="w-full md:w-2/4 flex flex-col md:items-start text-center md:text-left mb-4 md:mb-0">
                <div class="text-lg font-semibold mb-2">Big Chips</div>
                ...
                <p class="text-lg font-semibold">10.00 E£</p>
            </div>

            <div class="w-full md:w-1/4 flex flex-col items-center md:items-end">
                <div class="flex items-center mb-2">
                    <button class="secondaryBtn px-3 py-1 border border-gray-400 rounded-lg text-gray-600">-</button>
                    <span class="mx-3">1</span>
                    <button class="mainGreenBtn px-3 py-1 bg-green-500 text-white rounded-lg">+</button>
                </div>
                <button class="flex items-center justify-center px-3 py-1 rounded-lg">
    ...
    <button class="mainGreenBtn block ms-auto mx-20">Add Prodcut</button>
</template>
