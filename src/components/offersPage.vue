        ...
        <div class="offers pt-10 mb-12 text-center">
            ...
            <section class="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mx-3 md:mx-5 md:gap-5">
                <div v-for="product in products" :key="product"
                    class="card bg-base-100 shadow-xl rounded-sm cursor-pointer mb-8">
                    <figure class="bg-stone-50 p-5 relative ">
                        ...
                        <div class="badges absolute top-3 px-3 w-full flex justify-between">
                            <div class="badge text-xs badge-secondary rounded-md bg-red-600 text-white py-1">{{
                                product.sale }}</div>
        ...
        <div class="products pt-10 mb-12 text-center">
            ...
            <section class="products-head mb-12 mx-10">
                ...
                <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
                    ...
                    <p class="text-lg md:text-2xl font-bold text-stone-900 w-fit">Explore Our Prodcuts</p>
                                ...
                                <figure class="bg-stone-50 p-5 relative ">
                                    ...
                                    <div class="w-full flex justify-center relative">
                                        ...
                                        <div class="sideNav">
                                            ...
                                            <div title="Add to Weekly Order" v-if="subscribed"
                                                class="bg-white p-1 rounded-full flex items-center justify-center">
