      ...
      <div v-if="productD" class="flex flex-col space-y-4">
        ...
        <div class="flex items-center space-x-2">
          <div class="rating rating-md relative">
            ...
            <input v-if="allRates[0] !== undefined" ref="inputs" :checked="allRates[0] === 1" type="radio"
              name="rating-7" class="mask mask-star-2 bg-orange-400" disabled />
            <input v-if="allRates[0] === undefined" ref="inputs" :checked="allRates[0] === 1" type="radio"
              name="rating-7" class="mask mask-star-2 bg-orange-400 opacity-[0.2]" disabled />
            <input v-if="allRates[0] !== undefined" ref="inputs" :checked="allRates[0] === 2" type="radio"
              name="rating-7" class="mask mask-star-2 bg-orange-400" disabled />
            <input v-if="allRates[0] === undefined" ref="inputs" :checked="allRates[0] === 2" type="radio"
              name="rating-7" class="mask mask-star-2 bg-orange-400 opacity-[0.2]" disabled />
            <input v-if="allRates[0] !== undefined" ref="inputs" :checked="allRates[0] === 3" type="radio"
              name="rating-7" class="mask mask-star-2 bg-orange-400" disabled />
            <input v-if="allRates[0] === undefined" ref="inputs" :checked="allRates[0] === 3" type="radio"
              name="rating-7" class="mask mask-star-2 bg-orange-400 opacity-[0.2]" disabled />
            <input v-if="allRates[0] !== undefined" ref="inputs" :checked="allRates[0] === 4" type="radio"
              name="rating-7" class="mask mask-star-2 bg-orange-400" disabled />
            <input v-if="allRates[0] === undefined" ref="inputs" :checked="allRates[0] === 4" type="radio"
              name="rating-7" class="mask mask-star-2 bg-orange-400 opacity-[0.2]" disabled />
            <input v-if="allRates[0] !== undefined" ref="inputs" :checked="allRates[0] === 5" type="radio"
              name="rating-7" class="mask mask-star-2 bg-orange-400" disabled />
            <input v-if="allRates[0] === undefined" ref="inputs" :checked="allRates[0] === 5" type="radio"
              name="rating-7" class="mask mask-star-2 bg-orange-400 opacity-[0.2]" disabled />
          </div>
        ...
        <div class="flex items-center relative">
          ...
          <button :disabled="this.quantity == 1" @click="this.quantity--"
            class="w-8 h-8 bg-white text-[#166534] border-2 border-solid border-gray-700">-</button>
          <input type="number" v-model="this.quantity" min="1" :max="productD.availability"
          ...
          <button :disabled="this.quantity == productD.availability" @click="this.quantity++"
            class="w-8 h-8 bg-[#166534] text-white border-2 border-solid border-[#166534]">+</button>
        </div>
        <div class="flex items-center space-x-2 ">
          <button :disabled="isButtonDisabled" @click="addToCart(productId, productD)"
        ...
        <div v-for="review in getReviews" :key="review" class="border-t pt-4">
          ...
          <div class="flex items-center mb-2">
            <div class="rating rating-sm relative">
              <input :checked="review[1].rating == 1" type="radio" name="rating-5"
                class="mask mask-star-2 bg-yellow-400 cursor-auto" disabled />
              <input :checked="review[1].rating == 2" type="radio" name="rating-5"
                class="mask mask-star-2 bg-yellow-400 cursor-auto" disabled />
              <input :checked="review[1].rating == 3" type="radio" name="rating-5"
                class="mask mask-star-2 bg-yellow-400 cursor-auto" disabled />
              <input :checked="review[1].rating == 4" type="radio" name="rating-5"
                class="mask mask-star-2 bg-yellow-400 cursor-auto" disabled />
              <input :checked="review[1].rating == 5" type="radio" name="rating-5"
                class="mask mask-star-2 bg-yellow-400 cursor-auto" disabled />
            </div>
          </div>
