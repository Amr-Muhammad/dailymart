<template>
    <div class="container mx-auto px-8 py-10">
      <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div v-if="productD" class="flex w-64 h-64 justify-center bg-[#F5F5F5] p-4 rounded-lg">
          <img :src="productD.image_url" alt="Product Image" class="max-w-full">
        ...
        <div v-if="productD" class="flex flex-col space-y-4">
          ...
          <div class="flex items-center space-x-4">
            ...
            <input type="number" v-model="productD.availability" min="1" :max="productD.availability" class="w-16 border border-gray-300 rounded">
          </div>
      ...
      <div class="mt-10">
        ...
        <div class="mt-4">
          <button @click="showModal = true" class="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition duration-200">
            Rate Product
          </button>
        </div>
      </div>
      ...
      <div v-if="showModal" class="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
        <div class="relative bg-green-900 p-8 rounded-2xl shadow-2xl w-full max-w-md">
          ...
          <div class="flex justify-center mb-6">
            <span v-for="star in 5" :key="star" @click="setRating(star)" class="text-4xl cursor-pointer transition-colors duration-200"
          ...
          <div class="flex justify-center">
            <button @click="submitReview" class="bg-yellow-500 hover:bg-yellow-600 text-white font-semibold px-6 py-2 rounded-lg shadow-md transition duration-200">
              Submit
            </button>
          </div>
        </div>
