   ...
   <div class=" max-w-auto w-[500px] p-6 bg-white rounded-lg shadow-lg">
     ...
     <form @submit.prevent="sendEmail" class="space-y-4">
       ...
       <textarea
         ...
         required
         rows="4"
         class="mt-1 resize-none block w-full max-w-lg px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
       ></textarea>
     </div>
